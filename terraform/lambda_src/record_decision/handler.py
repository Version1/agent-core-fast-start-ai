    ...
    try:
        ...
        _rds_execute(
            """INSERT INTO decisions (case_id, outcome, notes, decided_at)
               VALUES (:cid, :outcome, :notes, :decided_at::timestamptz)""",
            [
        ...
        if decision == "escalate":
            ...
            _rds_execute(
                """INSERT INTO escalations (case_id, reason, raised_by, created_at)
                   VALUES (:cid, :reason, :raised_by, :created_at::timestamptz)""",
                [
                    _rds_param("cid", case_id),
        ...
        action_label = f"Case {new_status.lower()}"
        ...
        audit_table.put_item(Item={
            ...
            "agent": decided_by,
            "action": action_label,
            "details": json.dumps({"decision": decision, "newStatus": new_status, "justification": justification}),
            "expiresAt": ttl,
        })
