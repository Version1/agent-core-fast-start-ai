...
variable "lambda_request_role_arn" {}
...
resource "aws_lambda_function" "get_case_status" {
  ...
  role             = var.lambda_request_role_arn
...
resource "aws_api_gateway_integration_response" "options_status" {
  ...
  depends_on = [
    ...
    aws_api_gateway_method_response.options_status_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_pack" {
  ...
  depends_on = [
    ...
    aws_api_gateway_method_response.options_pack_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_cases" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_cases,
    aws_api_gateway_method_response.options_cases_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_case_id" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_case_id,
    aws_api_gateway_method_response.options_case_id_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_decision" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_decision,
    aws_api_gateway_method_response.options_decision_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_assign" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_assign,
    aws_api_gateway_method_response.options_assign_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_email" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_email,
    aws_api_gateway_method_response.options_email_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_notifications" {
  ...
  depends_on = [
    ...
    aws_api_gateway_method_response.options_notifications_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_notification_read" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_notification_read,
    aws_api_gateway_method_response.options_notification_read_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_admin_users" {
  ...
  depends_on = [
    ...
    aws_api_gateway_method_response.options_admin_users_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_admin_user_role" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_admin_user_role,
    aws_api_gateway_method_response.options_admin_user_role_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_admin_user_status" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_admin_user_status,
    aws_api_gateway_method_response.options_admin_user_status_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_admin_user_id" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_admin_user_id,
    aws_api_gateway_method_response.options_admin_user_id_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_admin_policies" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_admin_policies,
    aws_api_gateway_method_response.options_admin_policies_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_admin_policy_id" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_admin_policy_id,
    aws_api_gateway_method_response.options_admin_policy_id_200,
  ]
}
...
resource "aws_api_gateway_integration_response" "options_users_me" {
  ...
  depends_on = [
    aws_api_gateway_integration.options_users_me,
    aws_api_gateway_method_response.options_users_me_200,
  ]
}
...
aws apigateway update-stage \
  ...
  --region ${var.region}
echo "Stage updated to deployment ${aws_api_gateway_deployment.cases.id}"
EOF
  }
