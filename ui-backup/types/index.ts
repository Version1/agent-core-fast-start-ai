...
export type CaseStatus =
  ...
  | 'AWAITING_DOCUMENTS' | 'INTAKE_VALIDATED'
  | 'DOCS_TECHNICALLY_VALIDATED' | 'DOCS_TECHNICALLY_FAILED'
  | 'DATA_EXTRACTED' | 'EXTRACTION_FAILED'
  | 'POLICY_EVALUATED' | 'POLICY_EVALUATION_FAILED'
...
export type CaseDetail = {
  ...
  aiSummary?: string;
  ruleEvaluations?: Array<{ ruleId?: string; rule?: string; passed: boolean; reason?: string; blocking?: boolean; status?: string }>;
  validationResults?: Array<{ documentType?: string; isValid?: boolean; reason?: string }>;
